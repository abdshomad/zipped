...
## Cycle 25: Query-Aware Perplexity & Document Budgeting (LLMLingua + Supercompress) [DONE]
- [x] `25.1.1` **Perplexity & Information Entropy Scaffolding:** Implement `QueryAwareBudgetAllocator` in `services/researcher/perplexity_budget.py` calculating token-level surprisal and block entropy.
